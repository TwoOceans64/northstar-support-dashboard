...
export default function Home() {
  return (
    <main>
      {/* Hero Banner */}
      <section
        className="relative bg-cover bg-center h-100 flex items-center justify-center text-center"
      ...
      >
        <div className="bg-gray-100/80 rounded-lg p-8 shadow-md">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <ServiceCard
              icon={
                <div className="mx-auto text-green-600 mb-4">
                  <FaBoxOpen size={40} />
                </div>
              }
            ...
            <ServiceCard
              icon={
                <div className="mx-auto text-red-600 mb-4">
                  <FaUndo size={40} />
                </div>
              }
            ...
            <ServiceCard
              icon={
                <div className="mx-auto text-purple-600 mb-4">
                  <FaSearch size={40} />
                </div>
              }
